            ...
            <?php else: ?>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded shadow p-4 flex flex-col items-center">
                        ...
                        ?>
                        <img src="<?= htmlspecialchars($img_src) ?>" alt="<?= htmlspecialchars($p['titulo']) ?>" class="w-full h-56 aspect-square object-cover rounded-xl mb-2 cursor-pointer" style="min-height:14rem;max-height:14rem;min-width:14rem;max-width:100%;" onclick="mostrarModal(<?= $p['id'] ?>)">
